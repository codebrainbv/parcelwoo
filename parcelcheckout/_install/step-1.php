...
?' . '>';
			...
			{
				if(!PARCELCHECKOUT_INSTALL::setFile('/idealcheckout/configuration/database.php', $sFileData, $aFormValues))
				{
					PARCELCHECKOUT_INSTALL::output('<p>Cannot save database settings to: /idealcheckout/configuration/database.php</p>');
				}
			}
		}
		else
...
?' . '>';
		...
		if(!PARCELCHECKOUT_INSTALL::setFile('/idealcheckout/configuration/install.php', $sFileData, $aFormValues))
		{
