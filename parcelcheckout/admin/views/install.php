...
PRIMARY KEY (`id`));";
		...
		public static function drawFormFields($aSelectedGateway)
		{
			...
			elseif($aSelectedGateway['code'] == 'ABN Amro - iDEAL Integrated')
			{
				...
				$sHtml .= '<tr class="hide-c"><td><input name="parcelcheckout_private_key_file" type="text" value="private.key"></td></tr>';
				$sHtml .= '<tr class="hide-c"><td><b>Private Certificate File</b> <em>*</em> (Bestandsnaam van uw private certificate file)</td></tr>';
				$sHtml .= '<tr class="hide-c"><td><input name="parcelcheckout_private_certificate_file" type="text" value="private.cer"></td></tr>';
			}
			...
			elseif($aSelectedGateway['code'] == 'Paycheckout - Direct ebanking')
			{
				$sHtml .= '<tr class="hide-c"><td><p><b>Webshop ID</b> (Deze vind u op het Paycheckout dashboard.)</p></td></tr>';
				$sHtml .= '<tr class="hide-c"><td><p><input class="text" type="text" name="parcelcheckout_webshop_id" value=""></p></td></tr>';
				$sHtml .= '<tr class="hide-c"><td><p><b>Encryption Password</b> (Deze vind u op het Paycheckout dashboard.)</p></td></tr>';
